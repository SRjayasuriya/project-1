...
SECRET_KEY = 'django-insecure-%2*(+k701l72qm404f(1ikn9)^9nhh2$k^-ip%d!%m69)1qd)v'
...
CSRF_TRUSTED_ORGINS = ['https://project-1-production-00d2.up.railway.app']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.context_process.category_context',
